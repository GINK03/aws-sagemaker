...
個人でデータサイエンスコンペとかやるのにJupyterをさくっと立てて使いたいニーズがあるのと、会社でのセキュリティを担保した環境でのJupyterを利用できる例のユースけーすとして、GW中に自分の個人契約のAWSで一通りのサーベイを行いました。 
...
SageMakerのIF自体が微妙にわかりにくく、学習コストがかかり続けるので、必要でなければ、ScikitLearnとかでローカルで動作させてしまったほうが楽かなと思いました。  
